...
public class EventPlaceApi {
    ...
    public ResponseEntity getAll() {
        try {
            return ResponseEntity.ok(eventPlaceService.getAll());
        } catch (Exception e) {
    ...
    public ResponseEntity getOne(@PathVariable Long id) {
        try {
            return ResponseEntity.ok(eventPlaceService.getOne(id));
    ...
    @PostMapping
    public ResponseEntity create(@RequestBody EventPlace eventPlace) {
        try {
