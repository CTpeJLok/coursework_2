...
public class TeamUserApi {
    ...
    public ResponseEntity getAll() {
        try {
            return ResponseEntity.ok(teamUserService.getAll());
        } catch (Exception e) {
    ...
    public ResponseEntity getOne(@PathVariable Long id) {
        try {
            return ResponseEntity.ok(teamUserService.getOne(id));
    ...
    @PostMapping
    public ResponseEntity create(@RequestBody TeamUser teamUser) {
        try {
